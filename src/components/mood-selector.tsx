  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerRow}>
        ...
        <Pressable
          style={({ pressed }) => [styles.graphShortcutBtn, { opacity: pressed ? 0.8 : 1 }]}
          onPress={onOpenGraph}>
          <Ionicons name="bar-chart" size={16} color="#6F4E37" />
          <ThemedText style={styles.graphShortcutText}>Gráfico</ThemedText>
        </Pressable>
      </View>
        ...
        <View style={[styles.savedMoodCard, { borderColor: activeMoodObj.color }]}>
          <View style={styles.savedMoodTop}>
            ...
            <View style={styles.savedMoodInfo}>
              ...
              <ThemedText style={styles.moodQuote}>"{activeMoodObj.quote}"</ThemedText>
            </View>
          </View>
          ...
          {(todayEntry.note || (todayEntry.tags && todayEntry.tags.length > 0)) && (
            <View style={styles.savedExtras}>
              {todayEntry.note ? (
                <ThemedText style={styles.savedNoteText}>"{todayEntry.note}"</ThemedText>
              ) : null}
          ...
          {/* Botones de acción: Cambiar estado & Ver gráfico */}
          <View style={styles.savedActionsRow}>
            ...
            <Pressable
              ...
              <ThemedText style={styles.viewStatsBtnText}>Ver Estadísticas</ThemedText>
            </Pressable>
          </View>
        </View>
      ) : (
